...
from . views import Verifyviewset, registration_view, f_pass, Verify_Code # Verification_seller
...
#FORGOT PASSWORD
    ...
    path('update_password/', views.update_password),  # THROUGH HEADER , For Password Reset Also
